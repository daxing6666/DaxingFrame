...
import com.daxingframe.frame.network.volley.NetworkError;
import com.daxingframe.frame.network.volley.NetworkResponse;
import com.daxingframe.frame.network.volley.NoConnectionError;
import com.daxingframe.frame.network.volley.RedirectError;
import com.daxingframe.frame.network.volley.Request;
import com.daxingframe.frame.network.volley.RetryPolicy;
import com.daxingframe.frame.network.volley.ServerError;
import com.daxingframe.frame.network.volley.TimeoutError;
import com.daxingframe.frame.network.volley.VolleyError;
import com.daxingframe.frame.network.volley.VolleyLog;
import com.daxingframe.frame.network.volley.Cache.Entry;
...
public class BasicNetwork implements Network {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                ...
                /**
                 * 自从上次请求后，请求的网页未修改过。服务器返回此响应时，不会返回网页内容。如果网页自请求者上次请求后再也没有更改过，
                 * 您应当将服务器配置为返回此响应（称为 If-Modified-Since HTTP 标头）。
     ...
     * 知识点补充:
     * 1:
     * 家都知道客户端浏览器是有缓存的，里面存放之前访问过的一些网页文件。
