package com.daxingframe.frame.ui.view.loading.monindicator;
...
public class MonIndicator extends View{
	...
	public MonIndicator(Context context, AttributeSet attrs) {
		...
		circleSpacing = (int)a.getDimension(R.styleable.loadingview_circleSpacing, paramsCreator.getDefaultCircleSpacing());
		int cycle = a.getInt(R.styleable.loadingview_cycle, 2000);//周期，默认为2秒
		cycle = cycle/2;
