...
public class MD5 {
    ...
    private final static MD5 instance = new MD5();
    ...
    public String getMD5_32(String inbuf) {
        md5Init();
    ...
    public String getMD5_16(String inbuf) {
        return getMD5_32(inbuf).substring(8, 24);
    }
    ...
    // md5Init是一个初始化函数，初始化核心变量，装入标准的函数
